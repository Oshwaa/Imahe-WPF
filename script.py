...
def detect_main_focus(image):
    ...
    if contours:
        ...
        # Check blur of the main focus area
        blur = get_blur(main_focus)  # Use your existing blur function here
        if blur >= 40:
            return main_focus
...
def get_criteria(reference_image):
    ...
    criteria = {
        'blurriness_max' : blurriness* 0.7,
        'exposure_min': exposure * 0.3,
    ...
    for filename in os.listdir(directory_path):
        if filename.lower().endswith(('.jpg', '.jpeg', '.png')):
            ...
            try:
                ...
                blur = get_blur(image)
                print(f'Filename: {filename}, Blur: {blur}')
                if blur < criteria['blurriness_max']:
                    ...
                    if main_focus is not None: 
                        ...
                        status = 'Bad'
                        reason_text = 'Main Focus is blurry'
                        bad_files.append(filename)
...
def main():
    ...
    directory_path = 'C:/Users/Oshwa/Desktop/Test' 
    reference_path = 'E:/.NODE_JS REPOSITORIES/Imahe-web/reference/CCP_8467.JPG'  
